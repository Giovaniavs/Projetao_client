      ...
      <Router>
        <Switch>
          <UserContextProvider>
            ...
            <Route component={PlataformRoutes} exact path="/(home|avaliacao|perfil|admin|perfilVerificacao|recusar|planSelector|paymentScreen|shopkeeperPayment|conectionsPending)" />
          </UserContextProvider>
        </Switch>
      </Router>
      <GlobalStyle />
