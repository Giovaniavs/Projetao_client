...
export default function TermsModal({ open, handleClose, handleRefuseTerm }) {
  return (
      ...
      >
        <ModalBody sx={{ width: 400 }}>
          ...
          <p id="parent-modal-description">
            {`A sua privacidade é importante para nós. É política do MeSafe
            respeitar a sua privacidade em relação a qualquer informação que
            possamos coletar no site MeSafe, e outros sites que possuímos e
            ...
            o serviço solicitado. Quando armazenamos dados, os protegemos dentro
            ...
            publicamente ou com terceiros, exceto quando exigido por lei.O nosso
            site pode ter links para sites externos que não são operados por
            ...
            suas respectivas políticas de privacidade. Você é livre para recusar
          ...
          <h3>Política de Cookies MeSafe</h3>
          <p id="parent-modal-description1">
        ...
        certos elementos da funcionalidade do site. Como usamos os cookies?
        ...
        que você usa. Desativar cookies Você pode impedir a configuração de
        cookies ajustando as configurações do seu navegador (consulte a
        Ajuda do navegador para saber como fazer isso). Esteja ciente de que
        a desativação de cookies afetará a funcionalidade deste e de muitos
        outros sites que você visita. A desativação de cookies geralmente
        resultará na desativação de determinadas funcionalidades e recursos
        deste site. Portanto, é recomendável que você não desative os
        ...
        processo de inscrição e administração geral. Esses cookies
        ...
        inscritos / não inscritos. Pedidos processando cookies relacionados
        ...
        precisos após a alteração das páginas. Cookies relacionados a
        formulários Quando você envia dados por meio de um formulário como
        ...
        preferências do site Para proporcionar uma ótima experiência neste
        ...
        afetada por suas preferências. Cookies de Terceiros Em alguns casos
        especiais, também usamos cookies fornecidos por terceiros
        confiáveis. A seção a seguir detalha quais cookies de terceiros você
        pode encontrar através deste site. Este site usa o Google Analytics,
        ...
        para rastrear e medir o uso deste site, para que possamos continuar
        produzindo conteúdo atrativo. Esses cookies podem rastrear itens
        como o tempo que você passa no site ou as páginas visitadas, o que
        ...
        apreciam. À medida que vendemos produtos, é importante entendermos
        as estatísticas sobre quantos visitantes de nosso site realmente
        ...
        adequado dos conteúdos e da informação que o MeSafe oferece no site
        e com caráter enunciativo, mas não limitativo: A) Não se envolver em
        ...
        ilegal, de apologia ao terrorismo ou contra os direitos humanos; C)
        Não causar danos aos sistemas físicos (hardwares) e lógicos
        (softwares) do MeSafe, de seus fornecedores ou terceiros, para
